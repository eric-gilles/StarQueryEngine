package qengine_concurrent.model;
...
class StarQueryTest {
    ...
    void testStarQueryEquals() {
        ...
        qengine_concurrent.model.RDFAtom atomWithDifferentVariable = new qengine_concurrent.model.RDFAtom(differentVariable, predicate1, object1);
        qengine_concurrent.model.RDFAtom atomWithDifferentVariable2 = new qengine_concurrent.model.RDFAtom(differentVariable, predicate2, object2);
        List<qengine_concurrent.model.RDFAtom> rdfAtomsWithDifferentVariable = List.of(atomWithDifferentVariable, atomWithDifferentVariable2);
        Collection<Variable> differentAnswerVariables = List.of(differentVariable);
        qengine_concurrent.model.StarQuery queryWithDifferentAnswerVariables = new StarQuery("Requête étoile différente", rdfAtomsWithDifferentVariable, differentAnswerVariables);
    ...
    void testAsFOQuery() {
        ...
        qengine_concurrent.model.RDFAtom atom1 = new qengine_concurrent.model.RDFAtom(centralVariable, predicate1, object1);
        qengine_concurrent.model.RDFAtom atom2 = new qengine_concurrent.model.RDFAtom(centralVariable, predicate2, object2);

        List<RDFAtom> rdfAtoms = List.of(atom1, atom2);
        Collection<Variable> answerVariables = List.of(centralVariable);

        // Création de la requête étoile
        qengine_concurrent.model.StarQuery starQuery = new StarQuery("Requête étoile", rdfAtoms, answerVariables);
